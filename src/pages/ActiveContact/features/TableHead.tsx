      ...
      <tr>
        <th className="px-4 py-3 ">
          <div className="flex gap-1 items-center">
            <span>Full Name</span> <SortIcon />
          </div>
        </th>
        <th className="px-4 py-3 fex">
          <div className="flex gap-1 items-center">
            <span>Status</span> <SortIcon />
          </div>
        </th>
        <th className="px-4 py-3 ">
          <div className="flex gap-1 items-center">
            <span>Job Title</span> <SortIcon />
          </div>
        </th>
        <th className="px-4 py-3 ">
          <div className="flex gap-1 items-center">
            <span>Company</span> <SortIcon />
          </div>
        </th>
        <th className="px-4 py-3 ">
          <div className="flex gap-1 items-center">
            <span>Phone Number</span> <SortIcon />
          </div>
        </th>
        <th className="px-4 py-3 ">
          <div className="flex gap-1 items-center">
            <span>Email</span> <SortIcon />
          </div>
        </th>
        <th className="px-4 py-3 ">
          <div className="flex gap-1 items-center">
