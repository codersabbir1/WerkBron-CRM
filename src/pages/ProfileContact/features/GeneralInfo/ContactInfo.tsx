...
const ContactInfo: React.FC = () => {
  return (
    <div className="my-4 grid grid-cols-12 gap-4">
      <div className="col-span-5 border px-6 py-4 rounded-xl bg-[#fff]">
        <table className=" w-full">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className="text-[#303135] text-sm font-semibold">Lambert</td>
            </tr>
            <tr>
              <td className="text-[#71747D] text-sm font-medium py-2">
                Initials
            ...
            <tr>
              <td className="text-[#71747D] text-sm font-medium py-2">Email</td>
              <td className="text-[#303135] text-sm font-semibold">
                slambert@mail.com
              </td>
            </tr>
            ...
            <tr>
              <td className="text-[#71747D] text-sm font-medium py-2">Owner</td>
              <td className="text-[#303135] text-sm font-semibold">John Doe</td>
            </tr>
          </tbody>
        </table>
      </div>
      <div className="col-span-4 border px-6 py-4 rounded-xl bg-[#fff]">
      ...
      <div className="col-span-3 border px-6 py-4 rounded-xl bg-[#fff]">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-col gap-2">
            <h1 className="text-[#303135] text-sm font-semibold">Yesterday</h1>
            <div className="flex flex-col gap-1">
              <h2 className="text-[#303135] text-sm font-medium">
